  ...
  return (
    <div className="svg" style={{ width: "100%", height: "100%" }}>
      ...
      >
        ...
        <circle cx={bounds.width - 160} cy={280} r="20" fill="RGBA(189, 193, 199, 0.20)" />

        <circle cx={bounds.width / 2 + 200} cy={bounds.height - 1000} r="60" fill="url(#OrangeRed)"
          filter="url(#blurSun)" style={{ opacity: 1 }} />
